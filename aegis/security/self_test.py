"""
Aegis Sovereign AI Runtime - Adversarial Security Self-Test Suite
Implements the 6 core automated security verification tests defined in Aegis specification:
...
from aegis.knowledge.registry import find_authoritative_document, get_all_documents
from aegis.models.registry import import_model_manifest
...
def run_security_self_test() -> Dict[str, Any]:
    """
    Executes the comprehensive 6-point Aegis security self-test suite.
    ...
    tests_run.append({
        ...
        "description": "Verify that Aegis rejects older revisions (Rev2, Rev5) and selects only the active authoritative approved revision (Rev8).",
