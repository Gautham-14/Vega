...
from aegis.storage.database import execute_write, query_one, query_all
from aegis.security.firewall import ContextFirewall
from aegis.knowledge.registry import find_authoritative_document, get_all_documents, get_document_by_id
from aegis.knowledge.policy import CLEARANCES
...
class TaskRunner:
    ...
    def _execute_pump_inspection_demo(
        ...
        """
        Executes the flagship Aegis main demo workflow:
        ...
        artifact_markdown = "\n".join([
            ...
            "**Execution Mode:** SIMULATION MODE â€” synthetic training data.",
