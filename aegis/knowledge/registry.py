"""
Aegis Sovereign AI Runtime - Authority-Aware Knowledge Registry
Manages revision tracking, equipment applicability, superseded rejection logic,
and department authorization metadata.
"""
import hashlib
from datetime import date
from aegis.config import MAX_FILE_SIZE_BYTES
from aegis.knowledge.policy import rejection_reason
...
def find_authoritative_document(
    ...
    """
    Demonstrates Aegis's Authority-Aware Knowledge Retrieval.
    Even if older documents (Rev2, Rev5) match keywords, Aegis filters:
