"""
Vega Sovereign AI Runtime - Hardware API Route
"""
...
def get_profiles() -> List[Dict[str, Any]]:
    ...
    return profiles if os.environ.get("VEGA_ENABLE_DEMO_ENDPOINTS") == "1" else [profile for profile in profiles if profile["id"] == "REAL"]
