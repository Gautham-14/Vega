"""
Vega Sovereign AI Runtime - Dashboard API Route
"""
from fastapi import APIRouter
from typing import Dict, Any
from vega.models.registry import get_all_models
from vega.knowledge.registry import get_all_documents
from vega.hardware.scheduler import get_effective_hardware
from vega.security.firewall import get_recent_security_events
from vega.receipts.generator import get_all_receipts
from vega.runtime.task_runner import get_all_tasks
from vega.security.self_test import get_last_self_test_result
