...
from vega.control.store import Denied, digest, put, require, receipt, sign
from vega.control.policy import POLICY_VERSION, SKILLS, actor, approved
...
def register(components, identity):
    ...
    from vega.control.store import get
