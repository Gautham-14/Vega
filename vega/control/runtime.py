...
import time
from vega.control import artifacts, capsules, leases, packages
from vega.control.store import Denied, put, require, receipt, uid, digest, event
from vega.control.policy import actor, authorize_label, classify, label, approved, SKILLS, tool_guard, LEVELS, POLICY_VERSION
from vega.control.data import Workspace, disclose, context_check, tripwire
from vega.control.retrieval import HybridRetrieval, verify_claim
...
class GovernedRunner:
    ...
    def run(self, request, identity):
        ...
        try:
            ...
            text = "# Vega prototype evidence review\n\nSoftware simulation; advisory output.\n\n" + "\n".join(
