"""
Vega Sovereign AI Runtime - Model Adapter Base Interfaces
"""
...
class ModelAdapter(ABC):
    ...
    Every inference backend in Vega (mock or future local LLM runtime) implements this interface.
    """
    @abstractmethod
...
class OllamaAdapter(ModelAdapter):
    ...
    Connects to http://localhost:11434 without altering the Vega pipeline.
    """
    ...
    def generate(self, request: ModelRequest) -> ModelResponse:
        raise NotImplementedError("Real Ollama inference is marked Not Included in Vega Prototype Scope.")

    def embed(self, text: str) -> List[float]:
        raise NotImplementedError("Real embedding generation is marked Not Included in Vega Prototype Scope.")
...
class LlamaCppAdapter(ModelAdapter):
    ...
    def generate(self, request: ModelRequest) -> ModelResponse:
        raise NotImplementedError("Real llama.cpp GGUF inference is marked Not Included in Vega Prototype Scope.")
...
class VLLMAdapter(ModelAdapter):
    ...
    def generate(self, request: ModelRequest) -> ModelResponse:
        raise NotImplementedError("Real vLLM distributed inference is marked Not Included in Vega Prototype Scope.")
