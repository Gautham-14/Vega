"""
Vega Sovereign AI Runtime - Demo Model Profiles & Manifest Definitions
"""
import hashlib
...
DEMO_MODEL_PROFILES: List[Dict[str, Any]] = [
    {
        "id": "VEGA-DEMO-TEXT",
        "name": "Vega Industrial Text & Reasoning Engine",
        "version": "v1.4.0",
        ...
        "license": "Apache-2.0",
        "sha256": compute_simulated_sha256("VEGA-DEMO-TEXT-MANIFEST-v1.4.0"),
        "status": "QUALIFIED",
        "memory_req_mb": 4096,
        "cpu_cores_req": 2,
        "gpu_vram_req_mb": 0,
    ...
    {
        "id": "VEGA-DEMO-VISION",
        "name": "Vega Vision & Engineering P&ID Engine",
        "version": "v2.1.0",
        ...
        "license": "Apache-2.0",
        "sha256": compute_simulated_sha256("VEGA-DEMO-VISION-MANIFEST-v2.1.0"),
        "status": "QUALIFIED",
        "memory_req_mb": 8192,
        "cpu_cores_req": 4,
        "gpu_vram_req_mb": 0,
    ...
    {
        "id": "VEGA-DEMO-CODE",
        "name": "Vega Python & Logic Execution Engine",
        "version": "v1.2.0",
        ...
        "license": "Apache-2.0",
        "sha256": compute_simulated_sha256("VEGA-DEMO-CODE-MANIFEST-v1.2.0"),
        "status": "QUALIFIED",
        "memory_req_mb": 6144,
        "cpu_cores_req": 2,
        "gpu_vram_req_mb": 0,
